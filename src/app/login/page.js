 ...
 return (
  <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
   ...
   >
    ...
    <p className="text-center text-gray-400 mb-8 text-sm">Enter your credentials to access the studio.</p>
    ...
    <form className="space-y-5" onSubmit={handleLogin}>
     ...
     <div className="mt-6 space-y-3">
      <Button variant="primary" type="submit" className="w-full py-4 text-lg shadow-lg shadow-primary/20">
       Enter Dashboard
      </Button>
      <Button type="button" variant="secondary" onClick={handleGoogleLogin} className="w-full py-3 text-sm">
       Sign in with Google
      </Button>
     </div>

     <p className="text-center text-sm text-gray-500 mt-6">
      Don&apos;t have an account? <Link href="/signup" className="text-accent hover:text-accent-glow hover:underline transition-colors">Sign Up</Link>
     </p>
    </form>
   </motion.div>
  </div>
